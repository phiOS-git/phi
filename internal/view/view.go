...
var Commands = []Command{
	...
	{"wallpaper", "generate the shell's procedural background texture"},
	{"vpn", "WireGuard tunnels: list, status, up, down, import, forget"},
	{"firewall", "inbound firewall (nftables): status, enable, preset, allow, log, blocked"},
	{"state", "get, set and list runtime state ($XDG_STATE_HOME/phi)"},
	{"doctor", "disk, systemd, dotfiles drift, SMART, services, packages, external declarations"},
